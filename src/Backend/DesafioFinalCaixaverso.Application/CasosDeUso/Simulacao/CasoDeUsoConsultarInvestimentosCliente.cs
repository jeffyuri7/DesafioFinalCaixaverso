...
public class CasoDeUsoConsultarInvestimentosCliente : ICasoDeUsoConsultarInvestimentosCliente
{
    ...
    public async Task<IReadOnlyCollection<HistoricoSimulacaoJson>> Executar(Guid clienteId, CancellationToken cancellationToken = default)
    {
        ...
        return simulacoes.Adapt<IReadOnlyCollection<HistoricoSimulacaoJson>>();
    }
}

...
VALUES
    (N'Poupança Caixa',N'Poupança',0.0350,0,0,0.01,0,120,1),
    (N'CDB Caixa Flex Liquidez Diária',N'CDB',0.0400,0,0,1000.00,6,36,1),
    (N'CDB Caixa Pré-Fixado 36 meses',N'CDB',0.1000,1,0,1000.00,36,72,1),
    (N'CDB Caixa Pós-Fixado CDI 24 meses',N'CDB',0.0850,1,0,500.00,24,48,1),
    (N'LCI Caixa 24 meses',N'LCI',0.0950,1,90,5000.00,24,60,1),
    (N'LCA Caixa 36 meses',N'LCA',0.0920,1,90,5000.00,36,72,1),
    (N'Tesouro Selic (via Caixa)',N'Tesouro Direto',0.0600,0,0,100.00,0,120,1),
    (N'Tesouro IPCA+ 5 anos (via Caixa)',N'Tesouro Direto',0.0800,1,30,100.00,60,120,1),
    (N'Fundo Caixa Renda Fixa Simples',N'Fundo (Renda Fixa)',0.0600,0,0,100.00,3,24,1),
    (N'Fundo Caixa Renda Fixa Longo Prazo',N'Fundo (Renda Fixa)',0.0650,1,30,1000.00,12,48,1),
    (N'Fundo Caixa Referenciado DI',N'Fundo Referenciado',0.0550,0,0,100.00,3,24,1),
    (N'Fundo Caixa Referenciado IPCA',N'Fundo Referenciado',0.0700,1,30,1000.00,12,48,1),
    (N'Fundo Caixa Multimercado Estratégico',N'Fundo (Multimercado)',0.0950,1,7,5000.00,12,48,1),
    (N'Fundo Caixa Multimercado Macro',N'Fundo (Multimercado)',0.1200,2,30,10000.00,36,96,1),
    (N'Fundo Caixa Multimercado Alocacao Macro',N'Fundo (Multimercado)',0.1100,2,30,8000.00,24,72,1),
    (N'Fundo Caixa Acoes Brasil',N'Fundo (Ações)',0.1500,2,90,2000.00,60,120,1),
    (N'Fundo Caixa Acoes Global',N'Fundo (Ações)',0.1300,2,90,2000.00,60,120,1),
    (N'Fundo Caixa Cambial Moeda',N'Fundo (Cambial)',0.1200,2,30,5000.00,24,72,1),
    (N'Fundo Caixa Imobiliario (FII)',N'Fundo Imobiliario',0.0850,1,30,1000.00,12,60,1),
    (N'Oferta Pública Debênture Infra (Caixa)',N'Oferta Pública',0.1100,1,365,10000.00,60,120,1),
    (N'Oferta Pública Nota Promissória Caixa',N'Oferta Pública',0.0900,0,90,5000.00,6,18,1),
    (N'Operacao Compromissada Caixa Curto Prazo',N'Compromissada',0.0450,0,0,10000.00,1,12,1),
    (N'Operacao Compromissada Caixa Longo Prazo',N'Compromissada',0.0550,1,30,5000.00,12,48,1),
    (N'Previdencia Caixa VGBL Conservador',N'Previdencia',0.0500,0,0,100.00,60,180,1),
    (N'Previdencia Caixa VGBL Moderado',N'Previdencia',0.0800,1,30,1000.00,120,240,1),
    (N'COE Caixa Capital Protegido (Simulado)',N'COE',0.1000,1,365,5000.00,12,48,1),
    (N'COE Caixa Alavancado Brasil (Simulado)',N'COE',0.1800,2,365,10000.00,36,96,1),
    (N'LCI Caixa Longo Prazo 60 mes',N'LCI',0.0980,1,90,5000.00,60,120,1),
    (N'LCA Caixa Longo Prazo 60 mes',N'LCA',0.0960,1,90,5000.00,60,120,1),
    (N'Fundo Caixa Multimercado Juros e Moedas',N'Fundo (Multimercado)',0.0900,1,30,5000.00,12,48,1),
    (N'ETF Caixa Brasil (simulado)',N'ETF',0.1400,2,2,1000.00,12,60,1),
    (N'Titulo Corporativo Caixa (simulado) - curto',N'Titulo Corporativo',0.0650,0,30,2000.00,6,24,1);
